...
#
# Development environment for candy-crash.
#
...
# (just deno) — not a generic estate default.
#
#   nix develop      # enter the shell
#   nix flake check  # verify this file evaluates (run before committing)
{
  description = "candy-crash development environment";
